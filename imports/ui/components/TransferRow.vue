...
<template>
  <div
    class="bg-ft-surface border-ft-ink-10 col-span-full grid
      grid-cols-subgrid items-center rounded-xl border px-3 py-[10px]"
  >
    ...
    <span class="text-ft-ink justify-self-end text-[16px] font-bold">{{
      value
    }}</span>
    <slot name="action" />
  </div>
